          ...
          <div className="flex justify-center items-center gap-12 flex-col sm:flex-row">
            ...
            <div className="flex flex-col bg-base-100 px-10 py-10 text-center items-center w-full max-w-xl rounded-3xl h-[90vh]">
              <form className="flex flex-col gap-4 w-[30vw] form-control">
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-sm text-left ml-2">Invoice Address</label>
                  <input type="text" className="input input-bordered" placeholder="Enter Invoice Amount" />
                </div>
                <div className="flex flex-col gap-1">
                  <label className="text-sm text-left ml-2">Desired Token</label>
                  <input type="text" className="input input-bordered" placeholder="Enter Desired Token" />
                </div>
                {/* File Upload */}
                <div className="flex flex-col gap-1">
                  <label className="text-sm text-left ml-2">Initial Liquidity</label>
                  <input type="text" className="input input-bordered" placeholder="Enter Initial Liquidity" />
                </div>
                <div className="flex justify-center">
                  <button className="btn btn-primary">Initiate Invoice Factoring</button>
                </div>
              </form>
            </div>
          </div>
